...
public class ImgSelConfig {
    ...
    private static String Tag="ImgSelConfig";
    ...
    public static class Builder implements Serializable {
        ...
        public Builder(ImageLoader loader) {
            ...
            if (FileUtils.isSdCardAvailable())//是否含有sd卡
           ...
           LogUtils.v(Tag,"isSdCardAvailable:"+FileUtils.isSdCardAvailable()+"拍照照片的保存地址"+filePath);
